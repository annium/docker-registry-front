...
{
    public static bool IsKnown(ScopeAction action) => _knownActions.Contains(action);
    ...
    private static readonly ImmutableArray<ScopeAction> _knownActions = [Push, Pull, Delete, Any];
